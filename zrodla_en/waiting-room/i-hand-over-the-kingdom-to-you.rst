...
Let the prayer already introduce into the theme of building the New Jerusalem. You can ask the Holy Spirit for the gift of unity and drawing from each other (from the experience of the whole Church), to be able to build on already established foundations. You can also use the “Our Father” prayer (note: “(...) hallowed be Thy name, **Thy Kingdom come** ”). This will be an appropriate introduction to the meeting: you can later ask participants how they understand these words and whether they are aware of what they ask God for.
...
* What do you do among other people when you wait?

* How can you expect the effects of your / your (plural) decisions together with others?

* How important is it to You that you can share with others your doubts, feelings related to waiting?

Let's look for similarities in our waiting in the group.
...
* How, according to me, does the Church wait for the Parousia?

* How do I participate in this waiting?
...
Let's notice that what divides us now will not take place in the New Jerusalem. There, ideal peace will prevail. You can ask participants how they perceive such a vision.

How to build? - application
===========================

Of course, we will not wait passively until the Parousia “comes” by itself.

.. note:: This is what the Thessalonians wanted to do. They abandoned all duties and only prayed waiting for the Parousia to come. Saint Paul admonishes them in the fragment (2 Thess 3:10-11): "For even when we were with you, we gave you this command: Anyone unwilling to work should not eat. For we hear that some of you are living in idleness, mere busybodies, not doing any work."

We want to wait actively. How can this be done? A great example is Jesuit spirituality: this typically “scientific” order has a custom of including the abbreviation A.M.D.G. (Ad Maiorem Dei Gloriam - For the greater glory of God) in its scientific publications. This shows that we create the Kingdom of Heaven already today; in our everyday life. Close to this is the approach of Jews. They believe in „perfecting the world through the Kingdom of the Almighty" („L’takken olam b’malkut Shaddai"). So let's consider now:

* How can I build the Kingdom of God?

* Am I already doing something in this direction?

The application from this meeting can be e.g. creating and implementing a SMART plan regarding building the New Jerusalem, i.e. changing the world around oneself. This action can take place right away at the meeting, immediately after the retreat. The sooner we start acting, the more we will do.

.. note::
    | SMART is an acronym expanding in the following way:
    |
    | **Specific** – containing a concrete message;
    | **Measurable** – so that it can be measured, i.e. numerically express its realization;
    | **Attractive** – so that it is not boring and arouses curiosity and willingness to act;
    | **Realistic** – so that it is possible to achieve;
