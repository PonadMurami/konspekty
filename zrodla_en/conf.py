...
SHARED_DIR = os.path.join(SHARED_ROOT, "szablon")
...
# Prefer shared "vendored" extensions from ../zrodla_pl/szablon (e.g. sphinx_tags)
sys.path.insert(0, SHARED_DIR)
# Also allow importing the `szablon` package itself (../shared)
...
f = open(os.path.join(SHARED_DIR, 'latex.sty'), 'r', encoding='utf-8')
PREAMBLE = f.read()
...
latex_documents = [
  ('index', 'konspekty.tex', u'Meeting outlines',
   u'Above the Walls', 'book')
]
