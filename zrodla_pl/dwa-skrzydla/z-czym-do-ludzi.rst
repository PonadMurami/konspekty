...
.. tags:: tresc|poslanie|Posłanie, tresc|odpowiedzialnosc|Odpowiedzialność, tresc|komunikacja|Komunikacja, tresc|wolnosc|Wolność, metoda|praca-z-tekstem|Praca z~tekstem, metoda|pytania-do-dzielenia|Pytania do dzielenia, typ|formacyjne|Formacyjne
...
Jeśli widzisz potrzebę podkreślenia tego zagadnienia (bo np. nie wybrzmiało, albo widzisz, że Twoi uczestnicy nie są do tego wystarczająco przekonani), możesz zaproponować taki eksperyment:
